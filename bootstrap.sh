...
# TODO: need to setup a role to access EC2 metadata to get credentials (and configure an IAM user for the service): https://docs.aws.amazon.com/cli/latest/userguide/cli-configure-metadata.html
# shellcheck disable=SC2154
# shellcheck disable=SC2086
